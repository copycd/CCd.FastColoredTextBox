                ...
                if (e.ColumnIndex == 1)
                    ...
                    switch (item.type)
                    {
                        case ExplorerItemType.Class:
                            e.Value = global::Test_WinFormsApp.Properties.Resources.class_libraries;
                            return;
                        case ExplorerItemType.Method:
                            e.Value = global::Test_WinFormsApp.Properties.Resources.box;
                            return;
                        case ExplorerItemType.Event:
                            e.Value = global::Test_WinFormsApp.Properties.Resources.lightning;
                            return;
                        case ExplorerItemType.Property:
                            e.Value = global::Test_WinFormsApp.Properties.Resources.property;
                            return;
                    }
            }
            catch{;}
