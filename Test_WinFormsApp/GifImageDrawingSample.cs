...
namespace Tester
{
    public partial class GifImageDrawingSample : Form
    {
        ...
        public GifImageDrawingSample()
        {
            ...
            style.ImagesByText.Add(@":bb", Test_WinFormsApp.Properties.Resources.bye);
            style.ImagesByText.Add(@":D", Test_WinFormsApp.Properties.Resources.lol);
            style.ImagesByText.Add(@"8)", Test_WinFormsApp.Properties.Resources.rolleyes);
            style.ImagesByText.Add(@":@", Test_WinFormsApp.Properties.Resources.unsure);
            style.ImagesByText.Add(@":)", Test_WinFormsApp.Properties.Resources.smile_16x16);
            style.ImagesByText.Add(@":(", Test_WinFormsApp.Properties.Resources.sad_16x16);
